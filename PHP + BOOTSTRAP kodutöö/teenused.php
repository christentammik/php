      ...
      <div class="d-flex">
        <nav class="navbar navbar-expand-lg">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li><button type="button" class="btn btn-primary">Kontakt</button></li>
          </ul>
          </div>
        </nav>
        </div>
    ...
    <div class="row my-4">
      <div class="col-md-6 offset-md-3">
        ...
        <div class="mb-3"> <!-- Class mis on valitud bootstrapist -->
          ...
          <input type="number" class="form-control" id="toode2" name="toode2"> 
        </div>
...
<?php
    if (!empty($_GET["toode1"]) && $t2 = !empty($_GET["toode2"])) {
    ...
    if ($t1 < 0 || $t2 < 0) { //Kui on väiksem kui 0 siis tuleb kirje
      echo "<div class='row my-4'>"; //Vormistus
      echo "<div class='col-md-6 offset-md-3'>"; //Vormistus
      echo "<div class='alert alert-danger' role='alert'>"; //Kirje kui on valesti
      echo "Sisestatud väärtus ei saa olla negatiivne!";
      echo "</div>";
      echo "</div>";
      echo "</div>";
  } elseif (!empty($_GET["toode1"]) && !empty($_GET["toode2"]) && empty($_GET["noustun"])) { // Esimesed 2 näitavad, et poleks tühi ja viimane kontrollib veel boxi
    echo "<div class='row my-4'>";
    echo "<div class='col-md-6 offset-md-3'>";
    echo "<div class='alert alert-danger' role='alert'>";
    echo "Peate nõustuma teenusetingimustega!";
    echo "</div>";
    echo "</div>";
    echo "</div>";
} else {
  echo "<div class='row my-4'>";
  echo "<div class='col-md-6 offset-md-3'>";
  echo "Hamburgerid: $t1 tk<br>";
  echo "Hot-dogid: $t2 tk<br>";
